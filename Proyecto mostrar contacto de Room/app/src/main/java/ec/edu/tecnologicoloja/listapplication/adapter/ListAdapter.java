...
public class ListAdapter extends ArrayAdapter<Persona> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView == null || convertView.getTag() == null) {
            ...
            viewHolder.vItemName.setText(list.get(position).getNombre()); //se fija cada objeto del arreglo.
          Glide.with(context).load("http://i.imgur.com/DvpvklR.png")  //Libreria Glide
